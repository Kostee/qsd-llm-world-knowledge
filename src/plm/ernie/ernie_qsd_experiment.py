...
# python C_experiments/ernie/ernie_qsd_experiment.py --csv_path C_experiments/data/dataset_for_llms.csv
...
def main():
    parser = argparse.ArgumentParser(
        description='ERNIE 2.0 QSD 5-Fold Cross-Validation'
    )
    parser.add_argument('--csv_path', type=str, required=True)
    parser.add_argument('--folds_path', type=str,
                        default='C_experiments/data/folds_indices.csv')
    parser.add_argument('--model_name', type=str, default='nghuyong/ernie-2.0-en')
